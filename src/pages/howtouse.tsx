      ...
      <div className='container'>
        <div className='text'>How to Use</div>
            ...
            <div className='message'>
                ...
                <div className='title'>1. To use the Dream Home option:</div>
                    <ul className='black'>
                ...
                <div className='bracket'>
                <div className='title' >2. To use the housing calculator to determine the best choice of housing:</div>
                    <ul className='black'>
                ...
                <div className='bracket'>
                <div className='title'>3. To use the loan calculator:</div>
                    <ul className='black'>
